...
class BaseClient(ABC):
    ...
    @abstractmethod
    async def generate_content(self, prompt: str, **kwargs: Any) -> Any:  # domain returns its own response type
        """Generate a single response."""
        raise NotImplementedError

    @abstractmethod
    async def stream_generate_content(self, prompt: str, **kwargs: Any) -> AsyncIterator[Any]:
